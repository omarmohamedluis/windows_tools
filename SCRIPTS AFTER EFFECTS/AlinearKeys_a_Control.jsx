// AsignarMarcadores_porSeleccion_RefLayerActivo.jsx
// Fuente SIEMPRE: marcadores de una CAPA de la COMPOSICIÓN ACTIVA (elegida en el UI).
// Par 1 = (M1–M2) → 1ª capa seleccionada; Par 2 = (M3–M4) → 2ª, etc.
// Remapea todos los keys de la propiedad elegida para que key1 caiga en IN y keyN en OUT.
...
(function(){
    ...
    function buildUI(comp){
        ...
        ddProp.selection = 1; // Posición por defecto
        ...
        var info = win.add("statictext", undefined,
            "Par 1=(M1–M2) → 1ª capa seleccionada; Par 2=(M3–M4) → 2ª, etc.\n" +
            "Usa una capa (Null/Sólida) como referencia y pon ahí los marcadores.",
            {multiline:true}
        );
        info.maximumSize.width = 430;
    ...
    // “Refrescar” (no estrictamente necesario, pero por si acaso)
